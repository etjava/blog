...
<script type="text/javascript">
	...
	function deleteBlog(){
		...
		$.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("${pageContext.request.contextPath}/admin/blog/delete.html",{ids:ids},function(result){
					if(result.success){
...
<table id="dg" title="博客管理" class="easyui-datagrid" 
  ...
  url="${pageContext.request.contextPath}/admin/blog/list.html" fit="true" toolbar="#tb" scrollbarSize=0>
  <thead>
  	<tr>
...
<div id="tb">
	...
	<div>
		<a href="javascript:modifyBlog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
