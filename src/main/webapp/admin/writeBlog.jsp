...
<div id="p" class="easyui-panel" title="编写博客" style="padding: 10px">
    <table cellspacing="20px">
        <tr>
            <td width="80px"><strong>博客标题：</strong></td>
            <td>
                <input type="text" id="title" name="title" style="width: 600px;height:30px;"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td valign="top"><strong>博客内容：</strong></td>
            <td>
                <script id="editor" name="content" type="text/plain" style="width:97%;height:450px;"></script>
            </td>
        </tr>
        <tr>
            <td><strong>关键字：</strong></td>
            <td>
                <input type="text" id="keyWord" name="keyWord" style="width: 600px;height:30px;"/>&nbsp;(多个关键字中间用空格隔开)
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
